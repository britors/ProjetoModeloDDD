...
namespace ProjetoModeloDDD.MVC.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind(typeof(ICustomerAppService)).To(typeof(CustomerAppService));
            kernel.Bind(typeof(IProductAppService)).To(typeof(ProductAppService));

            kernel.Bind(typeof(IServiceBase<>)).To(typeof(ServiceBase<>));
            kernel.Bind(typeof(ICustomerService)).To(typeof(CustomerService));
            kernel.Bind(typeof(IProductService)).To(typeof(ProductService));

            kernel.Bind(typeof(IRepositoryBase<>)).To(typeof(RepositoryBase<>));
            kernel.Bind(typeof(ICustomerRepository)).To(typeof(CustomerRepository));
            kernel.Bind(typeof(IProductRepository)).To(typeof(ProdutoRepository));
